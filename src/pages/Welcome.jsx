...
export default function Welcome() {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-50 via-white to-yellow-50 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-yellow-400/20 rounded-full blur-3xl animate-float" style={{ animationDelay: "2s" }}></div>
      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center px-6 py-20 relative z-10">
        <div className="max-w-4xl mx-auto animate-fadeIn">
          ...
          <h2 className="text-5xl sm:text-6xl lg:text-7xl font-bold mb-6 animate-slideDown">
            ...
            <br />
            <span className="bg-gradient-to-r from-yellow-400 to-yellow-500 bg-clip-text text-transparent text-4xl sm:text-5xl lg:text-6xl">
              Municipality of Matnog
            </span>
          </h2>
          
          <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto mb-8 leading-relaxed animate-slideUp">
          ...
          {/* TRACEPER Acronym */}
          <div className="bg-white/80 backdrop-blur-md rounded-2xl p-6 mb-12 border border-blue-200/50 shadow-lg max-w-4xl mx-auto animate-scaleIn" style={{ animationDelay: "0.2s" }}>
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto w-full animate-fadeIn" style={{ animationDelay: "0.5s" }}>
          <div className="card-modern text-center group hover:scale-105 transition-transform duration-300">
      ...
      {/* Footer */}
      <footer className="relative z-10 text-center py-8 border-t border-gray-200/50 bg-white/50 backdrop-blur-sm">
