...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-teal-900 via-teal-700 via-teal-600 to-teal-500 relative overflow-hidden">
      {/* Floating Gradients */}
      <div className="absolute top-20 left-20 w-72 h-72 bg-yellow-accent/20 rounded-full blur-3xl animate-pulse" />
      <div className="absolute bottom-20 right-20 w-80 h-80 bg-blue-teal/30 rounded-full blur-3xl animate-pulse delay-2000" />
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-teal-300/10 rounded-full blur-3xl" />
        ...
        <div className="w-full max-w-md bg-white/80 backdrop-blur-2xl rounded-3xl shadow-[0_8px_40px_rgba(0,0,0,0.2)] p-10 border border-white/30">
          ...
          <div className="flex justify-center mb-8">
            <div className="flex items-center gap-3">
              <div className="relative w-14 h-14 bg-gradient-to-br from-teal-600 via-teal-700 to-teal-800 rounded-2xl flex items-center justify-center shadow-xl shadow-teal-500/40">
                <div className="absolute inset-0 bg-gradient-to-br from-yellow-accent/30 to-transparent rounded-2xl" />
                <svg
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-sm">
              Join the transparency portal of Matnog
            </p>
          </div>
